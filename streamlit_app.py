...
# put the normalized data into a table format
...
fruit_add = my_cur.execute("INSERT INTO FRUIT_LOAD_LIST (FRUIT_NAME) VALUES(" + streamlit.text_input('What fruit would you like to add?') + ")")
